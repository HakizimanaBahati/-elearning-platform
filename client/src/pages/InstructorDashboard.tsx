...
import { Plus, BookOpen, Users, TrendingUp, Edit2, Trash2 } from "lucide-react";
...
export default function InstructorDashboard() {
  ...
  const { data: courses = [], isLoading: coursesLoading, refetch } = trpc.courses.getByInstructor.useQuery();
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-indigo-100">Manage your courses and track student progress</p>
            </div>
            <Button
              size="lg"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-slate-900">{draftCourses}</p>
                </div>
        ...
        {/* Analytics Section */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900 mb-6">Course Analytics</h2>
          <AnalyticsCharts />
        </div>
          ...
          {coursesLoading ? (
            ...
            <Card>
              <CardContent className="pt-12 pb-12 text-center">
                ...
                <p className="text-lg text-slate-600 mb-4">You haven't created any courses yet</p>
                <Button
                  onClick={() => navigate("/instructor/courses/create")}
                ...
                <Card key={course.id} className="hover:shadow-lg transition-shadow">
                  <CardContent className="pt-6">
                    ...
                    <div className="pt-4 border-t flex items-center justify-between">
                      <div className="flex items-center gap-6 text-sm text-slate-600">
                        <div>
                          <span className="font-semibold text-slate-900">0</span> students enrolled
                        </div>
                        <div>
