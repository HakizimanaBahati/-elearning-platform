        ...
        <form onSubmit={onSubmit}>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-3 pt-2">
              ...
              <RadioGroup value={role} onValueChange={(val: "user" | "instructor") => setRole(val)} className="flex gap-4">
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="user" id="r1" />
                  <Label htmlFor="r1" className="cursor-pointer">Learn</Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="instructor" id="r2" />
                  <Label htmlFor="r2" className="cursor-pointer">Teach</Label>
                </div>
              </RadioGroup>
            </div>
          </CardContent>
